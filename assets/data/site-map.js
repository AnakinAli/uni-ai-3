window.GA_SITE = {
  ...
  "pages": {
    ...
    "ga": {
      ...
      "level": "Beginner",
      "parent": "home",
      "summary": "Въведение в genetic algorithms: какво са genotype, phenotype и fitness и защо изобщо се работи с популация от решения.",
      "bullets": [
      ...
      "example": "Типичен пример е настройване на параметри или комбинаторна задача, при която няма удобен градиент.",
    ...
    "ga-kanonichen-proces": {
      ...
      "example": "При N = 100 и G = 500 получавате около 50 000 fitness evaluations в generational режим.",
      "diagram": "ga-process-flow.svg",
      "equations": [
        "Budget ≈ N × G"
      ],
    ...
    "ga-koga-raboti": {
      ...
      "example": "Permutation-aware GA може да е силен за join ordering, но няма защо да доминира гладка convex optimization.",
    ...
    "teoriya": {
      ...
      "example": "Тук се срещат интуицията за building blocks, Markov гледната точка и по-строгият начин на оценяване.",
      "diagram": "theory-map.svg",
      "equations": [],
      "tables": [],
      "children": [
    ...
    "predstavyane": {
      ...
      "level": "Mixed",
      "parent": "home",
      "summary": "Representation drives search: encoding определя локалността, валидността и ефекта на operators.",
      "bullets": [
      ...
      "example": "Една и съща crossover идея може да е полезна за binary strings и разрушителна за permutations.",
    ...
    "predstavyane-binarno-diskretno": {
      ...
      "example": "OneMax е учебният пример, в който fitness е просто броят единици в бинарния низ.",
      "diagram": null,
      "equations": [
    ...
    "predstavyane-realno-kodirani": {
      ...
      "example": "PID tuning с real-valued genes е типичен пример за real-coded GA.",
      "diagram": "representation-overview.svg",
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "predstavyane-permutacionni": {
      ...
      "example": "Scheduling и join ordering са класически permutation domains.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "operatori": {
      ...
      "level": "Mixed",
      "parent": "home",
      "summary": "Selection, crossover и mutation са двигателят на търсенето, но трябва да са съвместими с представянето на задачата.",
      "bullets": [
      ...
      "example": "Дори силен оператор не помага, ако представянето не пази валидност или смислена локалност.",
    ...
    "operatori-selekciya": {
      ...
      "example": "Tournament size 2-4 често е добра начална точка.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "operatori-krastosvane": {
      ...
      "example": "При binary encoding cut-point c разделя parent prefix и suffix; при SBX spread around parents се контролира от eta_c.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "operatori-mutaciya": {
      ...
      "example": "За binary string с дължина 100, p_m = 0.01 означава средно около една промяна на индивид.",
      "diagram": null,
      "equations": [
        "p_m ≈ 1 / L"
      ],
    ...
    "fitnes": {
      ...
      "level": "Mixed",
      "parent": "home",
      "summary": "Fitness design свързва реалния проблем с натиска, който усеща алгоритъмът, и затова често е по-важен от дребното настройване на параметри.",
      "bullets": [
      ...
      "example": "Лошият fitness може да скрие полезния сигнал дори когато кодирането и операторите са добри.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [
    ...
    "fitnes-ogranicheniya": {
      ...
      "example": "Clipping при box constraints е лесно, но често дърпа population към boundaries.",
      "diagram": null,
      "equations": [
    ...
    "parametri": {
      ...
      "level": "Mixed",
      "parent": "home",
      "summary": "Population size, pressure, crossover, mutation и replacement трябва да се разглеждат като взаимосвързана система.",
      "bullets": [
      ...
      "example": "Параметрите са meaningful само ако знаете какво поведение искате да усилите или ограничите.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [
    ...
    "parametri-tuning-control": {
      ...
      "example": "Проста adaptive схема е да увеличите mutation, когато diversity падне под праг.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "parametri-sxodimost-diversitet": {
      ...
      "example": "Ако population стане почти идентична твърде рано, вероятно имате problem with pressure, mutation или representation.",
      "diagram": null,
      "equations": [
    ...
    "razshireniya": {
      ...
      "example": "Разширенията са естествен отговор, когато каноничният GA не е достатъчен за problem requirements.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [
    ...
    "razshireniya-memetichni": {
      ...
      "example": "Често работещ вариант е да се дооптимизират само elite candidates след GA variation.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "razshireniya-multiobjective": {
      ...
      "example": "Популационното търсене е естествено удобно за Pareto приближение, защото може да пази няколко компромиса едновременно.",
    ...
    "razshireniya-nsga-iii": {
      ...
      "example": "При много цели равномерното покритие на frontier-а става по-трудно и reference directions помагат да се запази структура.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "razshireniya-drugi-moea": {
      ...
      "example": "Когато problem structure пасва на weight vectors или indicator logic, алтернативите на NSGA-II могат да са по-подходящи.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "ocenyavane": {
      ...
      "level": "Mixed",
      "parent": "home",
      "summary": "Оценяването е отделна дисциплина: метрики, benchmark набори, отчет на времето и правила за повторяемост.",
      "bullets": [
      ...
      "example": "Честното benchmarking оценяване гледа и качеството, и надеждността, а не само най-щастливия run.",
    ...
    "implementaciya": {
      ...
      "example": "Добрата implementation структура е прозрачна, а не просто бързо работеща.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [
    ...
    "implementaciya-psevdokod": {
      ...
      "example": "Ако не знаете къде влиза repair, най-вероятно implementation-ът ви смесва representation logic и operators.",
      "diagram": null,
      "equations": [
    ...
    "implementaciya-biblioteki": {
      ...
      "example": "Изборът на библиотека следва problem type, нуждите за indicators и колко custom logic искате да пишете.",
    ...
    "implementaciya-reproducibility": {
      ...
      "example": "Ако не можете да повторите резултатите си, не можете и да защитите настройките си.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "prilozheniya": {
      ...
      "example": "Case studies са мостът между алгоритмичните принципи и реалните design компромиси.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [
    ...
    "prilozheniya-sql": {
      ...
      "example": "Population-ът може да описва candidate join orders, които се оценяват чрез plan cost.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
    ...
    "prilozheniya-genetichni-razmiti-sistemi": {
      ...
      "example": "Оптимизацията на membership functions е типичен пример за real-coded search в soft-computing context.",
      "diagram": null,
      "equations": [],
      "tables": [],
      "children": [],
